...
config = load['default']['news_recommendation_service']
...
NUM_OF_CLASSES = config['click_log_processor']['NUM_OF_CLASSES']
INITIAL_P = 1.0 / NUM_OF_CLASSES
ALPHA = 0.1

SLEEP_TIME_IN_SECONDS = config['click_log_processor']['SLEEP_TIME_IN_SECONDS']
...
def handle_message(msg):
    print "Received click log for user, handle user click log..."
