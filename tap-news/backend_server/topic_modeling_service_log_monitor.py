...
top_modeling_handler = EventHandler('../news_topic_modeling_service/system_log.log')
top_modeling_notifier = pyinotify.Notifier(wm, top_modeling_handler)

wm.add_watch(top_modeling_handler.file_path, mask)
top_modeling_notifier.loop()
