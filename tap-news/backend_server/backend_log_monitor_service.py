...
py_server_handler = EventHandler('../common/system_log.log')
py_server_notifier = pyinotify.Notifier(wm, py_server_handler)

wm.add_watch(py_server_handler.file_path, mask)
py_server_notifier.loop()
